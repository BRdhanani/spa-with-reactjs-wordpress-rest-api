...
function todo_list() {
    $labels = array(
        'name'               => _x( 'Todo-Lists', 'post type general name', 'links' ),
        'singular_name'      => _x( 'Todo-list', 'post type singular name', 'links' ),
        'menu_name'          => _x( 'Todo-Lists', 'admin menu', 'links' ),
        'name_admin_bar'     => _x( 'Todo-list', 'add new on admin bar', 'links' ),
        'add_new'            => _x( 'Add New', 'Todo-list', 'links' ),
        'add_new_item'       => __( 'Add New Todo-Lists', 'links' ),
        'new_item'           => __( 'New Todo-list', 'links' ),
        'edit_item'          => __( 'Edit Todo-list', 'links' ),
        'view_item'          => __( 'View Todo-list', 'links' ),
        'all_items'          => __( 'All Todo-Lists', 'links' ),
        'search_items'       => __( 'Search Todo-Lists', 'links' ),
        'parent_item_colon'  => __( 'Parent Todo-Lists:', 'links' ),
        'not_found'          => __( 'No Todo-Lists found.', 'links' ),
        'not_found_in_trash' => __( 'No Todo-Lists found in Trash.', 'links' )
    );
    $args = array(
        'labels'             => $labels,
        'description'        => __( 'Description.', 'links' ),
        'public'             => true,
...
if(isset($_POST['title'])){
	if(empty($_POST['title'])){
		echo "<div style='color: blue;text-align: center;'>Enter Your Task Details</div>";
	}else{
		$my_post = array(
				'post_type' => 'todo-list',
		...
		<div class="container" style="text-align: center;">
			Your Task List Created !
			 <div>
			 	<a href="" style="background-color: #3798cf;color: #fff;padding: 2px;line-height: 35px;text-decoration: none;font-size: 15px;font-weight: 600;">Back to form</a>
			 </div>
		</div>';
